...
5. Add to export resources **res://addons/applovinmax-ios** for using iOS.
...
## Notes
1. Permission **ACCESS_COARSE_LOCATION** will automatically be added when exported to Android.

2. For iOS 14.0+, consider using the ATT plugin (https://github.com/DrMoriarty/godot-ios-att) to meet Apple's rules.
